{
  'variables': {
    ...
    'common_sources' :  [
                          ...
                          'util/compare_messages.cc',   'util/compare_messages.hh',   
                          'util/table_collector.hh',
                          ...
                          'connector/user_manager_client.cc',        'connector/user_manager_client.hh',
                          'connector/srcsys_credential_server.cc',   'connector/srcsys_credential_server.hh',
                          'connector/srcsys_credential_client.cc',   'connector/srcsys_credential_client.hh',
                          'connector/cert_store_server.cc',          'connector/cert_store_server.hh',
  ...
  'targets' : [
    ...
    },
    {
      ...
      'type':                          'static_library',
      'hard_dependency':                1,
      'dependencies':                [ 'lz4', 'deps_/proto/proto.gyp:*', ],
    ...
    },
    {
      ...
      'type':                          'static_library',
      'dependencies':                [ 'rocksdb', 'common_with_faults', ],
      'cflags':                      [ '-std=c++11', '-Wall', ],
      'sources':                     [ '<@(cachedb_sources)', ],
    },
    {
